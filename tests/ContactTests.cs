//  --------------------------------------------------------------------------------------------------------------------
//  <copyright file=ContactTests.cs company="">
        ...
        public class ContactTests
            {
                ...
                //            };
                    ...
                    //    var serialised = JsonSerializer.Serialize<Contact>(sut);

                    //    Assert.That(serialised, Is.Not.Null.Or.Empty);
                    //    Assert.That(serialised.Length, Is.GreaterThan(40));

                    //    var deserialised = JsonSerializer.Deserialize<Contact>(serialised);
