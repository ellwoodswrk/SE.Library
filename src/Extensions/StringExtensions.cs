...
namespace LGov.Library.Extensions
    {
        ...
        /// <returns>
        ///     the string up to the first occurrence of the seperator, if the first characters are equal to the seperator then
        ...
        public static string LeadingNumericString(this string input)
        {
            ...
            {
                if (IsNumericCharacter(c.ToString()))
                {
